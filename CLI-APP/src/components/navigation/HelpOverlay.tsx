...
export const HelpOverlay: React.FC<HelpOverlayProps> = ({ onClose }) => {
  ...
  const slashCommands = [
    ...
    { cmd: '/search <query>', description: 'Search PRDs, notes, and contexts' },
    { cmd: '/note <text>', description: 'Capture a quick thought or idea' },
    { cmd: '/visualize [type]', description: 'Create charts and visualizations' },
